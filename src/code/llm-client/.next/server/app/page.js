...
class ChatGPTApi {
    path(path) {
        ...
        if (openaiUrl.length === 0) {
            ...
            openaiUrl = isApp ? constant/* DEFAULT_API_HOST */.Ky : apiPath;
        }
...
function AuthPage() {
    ...
    (0,react_.useEffect)(()=>{
        if ((0,client/* getClientConfig */.Z)()?.isApp) {
            navigate(constant/* Path */.y$.Settings);
        }
...
function useHtmlLang() {
    (0,react_.useEffect)(()=>{
        const lang = (0,locales/* getISOLang */.wY)();
...
const tauri_conf_namespaceObject = {"DR":{"i":"2.9.4"}};
...
const en_isApp = !!(0,client/* getClientConfig */.Z)()?.isApp;
const en = {
    WIP: "Coming Soon...",
    Error: {
...
const tw = {
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly)=>`編輯預設面具 ${readonly ? "（只读）" : ""}`,
            Download: "下載預設",
            Clone: "克隆預設"
        },
        Config: {
