...
/* harmony import */ var ts_dedent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2059);
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        ...
        case "day":
          ...
          break;
        case "week":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek */ .NGh.every(every));
          break;
        case "month":
      ...
      if (resultTickInterval !== null) {
        ...
        switch (interval) {
          ...
          case "day":
            ...
            break;
          case "week":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek */ .NGh.every(every));
            break;
          case "month":
