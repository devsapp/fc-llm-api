...
const drawImage = function(elem, x, y, link) {
  ...
  imageElem.attr("x", x);
  imageElem.attr("y", y);
  var sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .N)(link);
...
const drawEmbeddedImage = function(elem, x, y, link) {
  ...
  imageElem.attr("x", x);
  imageElem.attr("y", y);
  const sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .N)(link);
  imageElem.attr("xlink:href", "#" + sanitizedLink);
};
